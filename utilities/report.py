...
os.system('curl -s https://api.github.com/repos/dchassin/gridlabd/pulls\\?state=closed\\&per_page=100\\&sort=updated\\&direction=desc > pulls.json');
...
# get all issues
os.system('curl -s https://api.github.com/repos/dchassin/gridlabd/issues\\?state=open\\&per_page=1000\\&sort=created\\&direction=desc > issues.json');
