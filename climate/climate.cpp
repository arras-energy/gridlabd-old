...
climate::climate(MODULE *module) : gld_object()
{
	...
	if (oclass==NULL)
	{
		...
		if (gl_publish_variable(oclass,
			...
			PT_double,"solar_horiz",PADDR(solar_flux[CP_H]), PT_DESCRIPTION, "solar flux on horizontal surface",
			PT_double,"solar_north",PADDR(solar_flux[CP_N]), PT_DESCRIPTION, "solar flux on north surface",
			PT_double,"solar_northeast",PADDR(solar_flux[CP_NE]), PT_DESCRIPTION, "solar flux on northeast surface",
			PT_double,"solar_east",PADDR(solar_flux[CP_E]), PT_DESCRIPTION, "solar flux on east surface",
			PT_double,"solar_southeast",PADDR(solar_flux[CP_SE]), PT_DESCRIPTION, "solar flux on southeast surface",
			PT_double,"solar_south",PADDR(solar_flux[CP_S]), PT_DESCRIPTION, "solar flux on south surface",
			PT_double,"solar_southwest",PADDR(solar_flux[CP_SW]), PT_DESCRIPTION, "solar flux on southwest surface",
			PT_double,"solar_west",PADDR(solar_flux[CP_W]), PT_DESCRIPTION, "solar flux on west surface",
			PT_double,"solar_northwest",PADDR(solar_flux[CP_NW]), PT_DESCRIPTION, "solar flux on northwest surface",
			PT_double,"solar_raw[W/sf]",PADDR(solar_raw), PT_DESCRIPTION, "raw solar flux",
