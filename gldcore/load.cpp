...
void GldLoader::sublime_syntax(void)
{
	...
	output_message("  - glm");
	output_message("scope: source.glm");
	output_message("");
	...
	output_message("      scope: keyword.control.conditional");
	output_message("");
	output_message("  macros:");
	output_message("    - match: '\\b#[a-z]+\\b'");
	output_message("      scope: keyword.other.glm");
	output_message("");
	output_message("  directives:");
	output_message("    - match: '\\b(clock|module|class|object|modify|global|filter|intrinsic|set|import|export|script|library|link|dump|extension|instance|schedule)\\b'");
	output_message("      scope: keyword.directive.glm");
	output_message("");
	output_message("  names:");
	output_message("    - match: '\\b[A-Za-z_]+[-A-Za-z_:.0-9]*\\b'");
	output_message("      scope: entity.name.glm");
	output_message("");
	...
	output_message("      scope: punctuation.definition.string.begin.glm");
	output_message("      push: inside_string");
	output_message("");
	output_message("  inside_string:");
	output_message("    - meta_include_prototype: false");
	output_message("    - meta_scope: string.quoted.double.glm");
	output_message("    - match: '\\.'");
	output_message("      scope: constant.character.escape.glm");
	output_message("    - match: '\"'");
	output_message("      scope: punctuation.definition.string.end.glm");
	output_message("      pop: true");
	output_message("");
	output_message("  comments:");
	output_message("    # Comments begin with a '//' and finish at the end of the line.");
	output_message("    - match: '//'");
	output_message("      scope: punctuation.definition.comment.glm");
	output_message("      push:");
	output_message("        # This is an anonymous context push for brevity.");
	output_message("        - meta_scope: comment.line.double-slash.glm");
	output_message("        - match: $\\n?");
	output_message("          pop: true");
	output_message("");
}