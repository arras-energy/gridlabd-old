...
//   name,            xsdname,   default,   size,                    convertsize, data_to_string,              string_to_data,            initial_from_data,	create,               stream, compare ops,   get_part,                set_part
	...
	{"bool",          "string",  "FALSE",   sizeof(bool),            6,           convert_from_boolean,        convert_to_boolean,        NULL,                 NULL,                 NULL, {TCOPB(bool)},   },
	{"timestamp",     "string",  "TS_ZERO", sizeof(int64),           32,          convert_from_timestamp_stub, convert_to_timestamp_stub, NULL,                 NULL,                 NULL, {TCOPS(uint64)}, timestamp_get_part,      timestamp_set_part, },
	{"double_array",  "string",  "",        sizeof(double_array),    1024,        convert_from_double_array,   convert_to_double_array,   NULL,                 double_array_create,  NULL, {TCNONE},        double_array_get_part,   },
	{"complex_array", "string",  "",        sizeof(complex_array),   1024,        convert_from_complex_array,  convert_to_complex_array,  NULL,                 complex_array_create, NULL, {TCNONE},        complex_array_get_part,  },
