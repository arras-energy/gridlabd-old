...
//   name,            xsdname,   default,   size,                    convertsize, data_to_string,              string_to_data,            initial_from_data,	create,               stream, compare ops,   get_part,                set_part
	{"void",          "string",  NULL,      0,                       0,           convert_from_void,           convert_to_void            },
	{"double",        "decimal", "0.0",     sizeof(double),          24,          convert_from_double,         convert_to_double,         initial_from_double,  NULL,                 NULL, {TCOPS(double)}, },
	{"complex",       "string",  "0+0i",    sizeof(complex),         48,          convert_from_complex,        convert_to_complex,        NULL,                 NULL,                 NULL, {TCOPS(double)}, complex_get_part,        complex_set_part,  },
	{"enumeration",   "string",  "0",       sizeof(enumeration),     1024,        convert_from_enumeration,    convert_to_enumeration,    NULL,                 NULL,                 NULL, {TCOPS(uint64)}, },
	{"set",           "string",  "0",       sizeof(set),             1024,        convert_from_set,            convert_to_set,            NULL,                 NULL,                 NULL, {TCOPS(uint64)}, },
	{"int16",         "integer", "0",       sizeof(int16),           6,           convert_from_int16,          convert_to_int16,          NULL,                 NULL,                 NULL, {TCOPS(uint16)}, },
	{"int32",         "integer", "0",       sizeof(int32),           12,          convert_from_int32,          convert_to_int32,          NULL,                 NULL,                 NULL, {TCOPS(uint32)}, },
	{"int64",         "integer", "0",       sizeof(int64),           24,          convert_from_int64,          convert_to_int64,          NULL,                 NULL,                 NULL, {TCOPS(uint64)}, },
	...
	{"object",        "string",  NULL,      sizeof(OBJECT*),         64,          convert_from_object,         convert_to_object,         NULL,                 NULL,                 NULL, {TCOPB(object)}, object_get_part,         object_set_part,    },
	{"delegated",     "string",  NULL,      0,                       PSZ_DYNAMIC, convert_from_delegated,      convert_to_delegated       NULL,                 NULL,                 },
	{"bool",          "string",  "FALSE",   sizeof(bool),            6,           convert_from_boolean,        convert_to_boolean,        NULL,                 NULL,                 NULL,                 NULL, {TCOPB(bool)},   },
	{"timestamp",     "string",  "TS_ZERO", sizeof(int64),           32,          convert_from_timestamp_stub, convert_to_timestamp_stub, NULL,                 NULL,                 NULL,                 NULL, {TCOPS(uint64)}, timestamp_get_part,      timestamp_set_part, },
	{"double_array",  "string",  "",        sizeof(double_array),    1024,        convert_from_double_array,   convert_to_double_array,   NULL,                 double_array_create,  NULL, {TCNONE},        double_array_get_part,   NULL,               },
	{"complex_array", "string",  "",        sizeof(complex_array),   1024,        convert_from_complex_array,  convert_to_complex_array,  NULL,                 complex_array_create, NULL, {TCNONE},        complex_array_get_part,  NULL,               },
	{"real",          "decimal", "0.0",     sizeof(real),            24,          convert_from_real,           convert_to_real            NULL,                 },
	{"float",         "decimal", "0.0",     sizeof(float),           24,          convert_from_float,          convert_to_float           NULL,                 },
	...
	{"property",      "string",  NULL,      sizeof(OBJECTPROPERTY*), 256,         convert_from_propertyref,    convert_to_propertyref,    NULL,                 propertyref_create,   NULL, {TCNONE},        },
};
