...
DEPRECATED static struct s_varmap {
	...
	{"version.major", PT_int32, &global_version_major, PA_REFERENCE, "major version",NULL,NULL},
	{"version.minor", PT_int32, &global_version_minor, PA_REFERENCE, "minor version",NULL,NULL},
	{"version.patch", PT_int32, &global_version_patch, PA_REFERENCE, "patch number",NULL,NULL},
	{"version.build", PT_int32, &global_version_build, PA_REFERENCE, "build number",NULL,NULL},
	{"version.branch", PT_char256, &global_version_branch, PA_REFERENCE, "branch name",NULL,NULL},
	{"version",	PT_char1024, &global_version, PA_REFERENCE, "full version information",NULL,NULL},
	{"command_line", PT_char1024, &global_command_line, PA_REFERENCE, "command line",NULL,NULL},
	{"environment", PT_char1024, &global_environment, PA_PUBLIC, "operating environment",NULL,NULL},
	{"quiet", PT_bool, &global_quiet_mode, PA_PUBLIC, "quiet output status flag",NULL,NULL},
	{"warn", PT_bool, &global_warn_mode, PA_PUBLIC, "warning output status flag",NULL,NULL},
	{"debugger", PT_bool, &global_debug_mode, PA_PUBLIC, "debugger enable flag",NULL,NULL},
	{"gdb", PT_bool, &global_gdb, PA_PUBLIC, "gdb enable flag",NULL,NULL},
	{"debug", PT_bool, &global_debug_output, PA_PUBLIC, "debug output status flag",NULL,NULL},
	{"test", PT_bool, &global_debug_mode, PA_PUBLIC, "test enable flag",NULL,NULL},
	{"verbose", PT_bool, &global_verbose_mode, PA_PUBLIC, "verbose enable flag",NULL,NULL},
	{"iteration_limit", PT_int32, &global_iteration_limit, PA_PUBLIC, "iteration limit",NULL,NULL},
	{"workdir", PT_char1024, &global_workdir, PA_REFERENCE, "working directory",NULL,NULL},
	{"dumpfile", PT_char1024, &global_dumpfile, PA_PUBLIC, "dump filename",NULL,NULL},
	{"savefile", PT_char1024, &global_savefile, PA_PUBLIC, "save filename",NULL,NULL},
	{"dumpall", PT_bool, &global_dumpall, PA_PUBLIC, "dumpall enable flag",NULL,NULL},
	{"runchecks", PT_bool, &global_runchecks, PA_PUBLIC, "runchecks enable flag",NULL,NULL},
	{"threadcount", PT_int32, &global_threadcount, PA_PUBLIC, "number of threads to use while using multicore",NULL,NULL},
	{"profiler", PT_bool, &global_profiler, PA_PUBLIC, "profiler enable flag",NULL,NULL},
	{"pauseatexit", PT_bool, &global_pauseatexit, PA_PUBLIC, "pause at exit flag",NULL,NULL},
	{"testoutputfile", PT_char1024, &global_testoutputfile, PA_PUBLIC, "filename for test output",NULL,NULL},
	{"xml_encoding", PT_int32, &global_xml_encoding, PA_PUBLIC, "XML data encoding",NULL,NULL},
	{"clock", PT_timestamp, &global_clock, PA_PUBLIC, "global clock",NULL,NULL},
	{"starttime", PT_timestamp, &global_starttime, PA_PUBLIC, "simulation start time",NULL,NULL},
	{"stoptime", PT_timestamp, &global_stoptime, PA_PUBLIC, "simulation stop time",NULL,NULL},
	{"double_format", PT_char32, &global_double_format, PA_PUBLIC, "format for writing double values",NULL,NULL},
	{"complex_format", PT_char256, &global_complex_format, PA_PUBLIC, "format for writing complex values",NULL,NULL},
	{"complex_output_format", PT_enumeration, &global_complex_output_format, PA_PUBLIC, "complex output representation", cnf_keys,NULL},
	{"object_format", PT_char32, &global_object_format, PA_PUBLIC, "format for writing anonymous object names",NULL,NULL},
	{"object_scan", PT_char32, &global_object_scan, PA_PUBLIC, "format for reading anonymous object names",NULL,NULL},
	{"object_tree_balance", PT_bool, &global_no_balance, PA_PUBLIC, "object index tree balancing enable flag",NULL,NULL},
	{"kmlfile", PT_char1024, &global_kmlfile, PA_PUBLIC, "KML output file name",NULL,NULL},
	{"kmlhost", PT_char1024, &global_kmlhost, PA_PUBLIC, "KML server URL",NULL,NULL},
	{"modelname", PT_char1024, &global_modelname, PA_REFERENCE, "model name",NULL,NULL},
	{"execdir",PT_char1024, &global_execdir, PA_REFERENCE, "directory where executable binary was found",NULL,NULL},
	{"strictnames", PT_bool, &global_strictnames, PA_PUBLIC, "strict global name enable flag",NULL,NULL},
	{"website", PT_char1024, &global_urlbase, PA_PUBLIC, "url base string (deprecated)",NULL,NULL}, /** @todo deprecate use of 'website' */
	{"urlbase", PT_char1024, &global_urlbase, PA_PUBLIC, "url base string",NULL,NULL},
	...
	{"include", PT_char1024, &global_include, PA_REFERENCE, "include folder path",NULL,NULL},
	{"trace", PT_char1024, &global_trace, PA_PUBLIC, "trace function list",NULL,NULL},
	{"gdb_window", PT_bool, &global_gdb_window, PA_PUBLIC, "gdb window enable flag",NULL,NULL},
	{"tmp", PT_char1024, &global_tmp, PA_PUBLIC, "temporary folder name",NULL,NULL},
	{"force_compile", PT_int32, &global_force_compile, PA_PUBLIC, "force recompile enable flag",NULL,NULL},
	{"nolocks", PT_bool, &global_nolocks, PA_PUBLIC, "locking disable flag",NULL,NULL},
	{"skipsafe", PT_bool, &global_skipsafe, PA_PUBLIC, "skip sync safe enable flag",NULL,NULL},
	{"dateformat", PT_enumeration, &global_dateformat, PA_PUBLIC, "date format string", df_keys,NULL},
	{"init_sequence", PT_enumeration, &global_init_sequence, PA_PUBLIC, "initialization sequence control flag", isc_keys,NULL},
	{"minimum_timestep", PT_int32, &global_minimum_timestep, PA_PUBLIC, "minimum timestep",NULL,NULL},
	{"platform",PT_char8, global_platform, PA_REFERENCE, "operating platform",NULL,NULL},
	{"suppress_repeat_messages",PT_bool, &global_suppress_repeat_messages, PA_PUBLIC, "suppress repeated messages enable flag",NULL,NULL},
	{"maximum_synctime",PT_int32, &global_maximum_synctime, PA_PUBLIC, "maximum sync time for deltamode",NULL,NULL},
	{"run_realtime",PT_bool, &global_run_realtime, PA_PUBLIC, "realtime enable flag",NULL,NULL},
	{"enter_realtime",PT_timestamp, &global_enter_realtime, PA_PUBLIC, "timestamp to transition to realtime mode",NULL,NULL},
	{"realtime_metric",PT_double, &global_realtime_metric, PA_REFERENCE, "realtime performance metric (0=worst, 1=best)",NULL,NULL},
	{"no_deprecate",PT_bool, &global_suppress_deprecated_messages, PA_PUBLIC, "suppress deprecated usage message enable flag",NULL,NULL},
#ifdef _DEBUG
	{"sync_dumpfile",PT_char1024, &global_sync_dumpfile, PA_PUBLIC, "sync event dump file name",NULL,NULL},
#endif
	{"streaming_io",PT_bool, &global_streaming_io_enabled, PA_PROTECTED, "streaming I/O enable flag",NULL,NULL},
	{"compileonly",PT_bool, &global_compileonly, PA_PROTECTED, "compile only enable flag",NULL,NULL},
	{"relax_naming_rules",PT_bool,&global_relax_naming_rules, PA_PUBLIC, "relax object naming rules enable flag",NULL,NULL},
	{"browser", PT_char1024, &global_browser, PA_PUBLIC, "browser selection",NULL,NULL},
	{"server_portnum",PT_int32,&global_server_portnum, PA_PUBLIC, "server port number (default is find first open starting at 6267)",NULL,NULL},
	{"server_quit_on_close",PT_bool,&global_server_quit_on_close, PA_PUBLIC, "server quit on connection closed enable flag",NULL,NULL},
	{"client_allowed",PT_char1024,&global_client_allowed, PA_PUBLIC,"clients from which to accept connecdtions",NULL,NULL},
	{"autoclean",PT_bool,&global_autoclean, PA_PUBLIC, "autoclean enable flag",NULL,NULL},
	{"technology_readiness_level", PT_enumeration, &technology_readiness_level, PA_PUBLIC, "technology readiness level", trl_keys,NULL},
	{"show_progress",PT_bool,&global_show_progress,PA_PUBLIC, "show progress enable flag",NULL,NULL},
	{"checkpoint_type", PT_enumeration, &global_checkpoint_type, PA_PUBLIC, "checkpoint type usage flag", cpt_keys,NULL},
	{"checkpoint_file", PT_char1024, &global_checkpoint_file, PA_PUBLIC, "checkpoint file base name",NULL,NULL},
	{"checkpoint_seqnum", PT_int32, &global_checkpoint_seqnum, PA_PUBLIC, "checkpoint sequence number",NULL,NULL},
	{"checkpoint_interval", PT_int32, &global_checkpoint_interval, PA_PUBLIC, "checkpoint interval",NULL,NULL},
	{"checkpoint_keepall", PT_bool, &global_checkpoint_keepall, PA_PUBLIC, "checkpoint file keep enable flag",NULL,NULL},
	{"check_version", PT_bool, &global_check_version, PA_PUBLIC, "check version enable flag",NULL,NULL},
	{"random_number_generator", PT_enumeration, &global_randomnumbergenerator, PA_PUBLIC, "random number generator version control flag", rng_keys,NULL},
	{"mainloop_state", PT_enumeration, &global_mainloopstate, PA_PUBLIC, "main sync loop state flag", mls_keys,NULL},
	{"pauseat", PT_timestamp, &global_mainlooppauseat, PA_PUBLIC, "pause at time",NULL,NULL},
	{"infourl", PT_char1024, &global_infourl, PA_PUBLIC, "URL to use for obtaining online help",NULL,NULL},
	{"hostname", PT_char1024, &global_hostname, PA_PUBLIC, "unused",NULL,NULL},
	{"hostaddr", PT_char32, &global_hostaddr, PA_PUBLIC, "unused",NULL,NULL},
	{"autostart_gui", PT_bool, &global_autostartgui, PA_PUBLIC, "automatic GUI start enable flag",NULL,NULL},
	{"master", PT_char1024, &global_master, PA_PUBLIC, "master server hostname",NULL,NULL},
	{"master_port", PT_int64, &global_master_port, PA_PUBLIC, "master server port number",NULL,NULL},
	{"multirun_mode", PT_enumeration, &global_multirun_mode, PA_PUBLIC, "multirun enable flag", mrm_keys,NULL},
	{"multirun_conn", PT_enumeration, &global_multirun_connection, PA_PUBLIC, "unused", mrc_keys,NULL},
	{"signal_timeout", PT_int32, &global_signal_timeout, PA_PUBLIC, "unused",NULL,NULL},
	{"slave_port", PT_int16, &global_slave_port, PA_PUBLIC, "unused",NULL,NULL},
	{"slave_id", PT_int64, &global_slave_id, PA_PUBLIC, "unused",NULL,NULL},
	{"return_code", PT_int32, &global_return_code, PA_REFERENCE, "unused",NULL,NULL},
	{"exit_code", PT_int16, &global_exit_code, PA_REFERENCE, "The exit code for GridLAB-D",NULL,NULL},
	{"module_compiler_flags", PT_set, &global_module_compiler_flags, PA_PUBLIC, "module compiler flags", mcf_keys,NULL},
	{"init_max_defer", PT_int32, &global_init_max_defer, PA_REFERENCE, "deferred initialization limit",NULL,NULL},
	{"mt_analysis", PT_bool, &global_mt_analysis, PA_PUBLIC, "perform multithread profile optimization analysis",NULL,NULL},
	{"inline_block_size", PT_int32, &global_inline_block_size, PA_PUBLIC, "inline code block size",NULL,NULL},
	{"validate", PT_set, &global_validateoptions, PA_PUBLIC, "validation test options",vo_keys,NULL},
	{"sanitize", PT_set, &global_sanitizeoptions, PA_PUBLIC, "sanitize process options",so_keys,NULL},
	{"sanitize_prefix", PT_char8, &global_sanitizeprefix, PA_PUBLIC, "sanitized name prefix",NULL,NULL},
	{"sanitize_index", PT_char1024, &global_sanitizeindex, PA_PUBLIC, "sanitization index file spec",NULL,NULL},
	{"sanitize_offset", PT_char32, &global_sanitizeoffset, PA_PUBLIC, "sanitization lat/lon offset",NULL,NULL},
	{"simulation_mode",PT_enumeration,&global_simulation_mode,PA_PUBLIC, "current time simulation type",sm_keys,NULL},
	{"deltamode_allowed", PT_bool, &global_deltamode_allowed, PA_PUBLIC, "flag to allow simulation in deltamode",NULL,delta_modecheck},
	{"deltamode_timestep",PT_int32,&global_deltamode_timestep,PA_PUBLIC, "uniform step size for deltamode simulations",NULL,NULL},
	{"deltamode_maximumtime", PT_int64,&global_deltamode_maximumtime,PA_PUBLIC, "maximum time (ns) deltamode can run",NULL,NULL},
	{"deltaclock", PT_int64, &global_deltaclock, PA_PUBLIC, "cumulative delta runtime with respect to the global clock",NULL,NULL},
	{"delta_current_clock", PT_double, &global_delta_curr_clock, PA_PUBLIC, "Absolute delta time (global clock offset)",NULL,NULL},
	{"deltamode_updateorder", PT_char1024, &global_deltamode_updateorder, PA_REFERENCE, "order in which modules are update in deltamode",NULL,NULL},
	{"deltamode_iteration_limit", PT_int32, &global_deltamode_iteration_limit, PA_PUBLIC, "iteration limit for each delta timestep (object and interupdate)",NULL,NULL},
	{"deltamode_forced_extra_timesteps",PT_int32, &global_deltamode_forced_extra_timesteps, PA_PUBLIC, "forced extra deltamode timesteps before returning to event-driven mode",NULL,NULL},
	{"deltamode_forced_always",PT_bool, &global_deltamode_forced_always, PA_PUBLIC, "forced deltamode for debugging -- prevents event-driven mode",NULL,NULL},
	{"run_powerworld", PT_bool, &global_run_powerworld, PA_PUBLIC, "boolean that that says your system is set up correctly to run with PowerWorld",NULL,NULL},
	{"bigranks", PT_bool, &global_bigranks, PA_PUBLIC, "enable fast/blind set_rank operations",NULL,NULL},
	{"exename", PT_char1024, &global_execname, PA_REFERENCE, "argv[0] value",NULL,NULL},
	{"wget_options", PT_char1024, &global_wget_options, PA_PUBLIC, "wget/curl options",NULL,NULL},
	{"curl_options", PT_char1024, &global_wget_options, PA_PUBLIC, "wget/curl options",NULL,NULL},
	{"svnroot", PT_char1024, &global_svnroot, PA_PUBLIC, "svnroot",NULL,NULL},
	{"github", PT_char1024, &global_github, PA_PUBLIC, "github file repository",NULL,NULL},
	{"gitraw", PT_char1024, &global_gitraw, PA_PUBLIC, "github raw file access",NULL,NULL},
	{"allow_reinclude", PT_bool, &global_reinclude, PA_PUBLIC, "allow the same include file to be included multiple times",NULL,NULL},
	{"output_message_context", PT_set, &global_output_message_context, PA_PUBLIC, "control context from which debug messages are allowed", dmc_keys,NULL},
	{"permissive_access", PT_int32, &global_permissive_access, PA_PUBLIC, "enable permissive property access",NULL,NULL},
	{"relax_undefined_if", PT_bool, &global_relax_undefined_if, PA_PUBLIC, "allow #if macro to handle undefined global variable as empty strings",NULL,NULL},
	{"literal_if", PT_bool, &global_literal_if, PA_PUBLIC, "do not interpret lhs of #if macro as a variable name",NULL,NULL},
	{"validto_context", PT_enumeration, &global_validto_context, PA_PUBLIC, "events to which valid_to time applies, rather than just sync passes", vtc_keys,NULL},
	{"daemon_configfile", PT_char1024, &global_daemon_configfile, PA_PUBLIC, "name of configuration file used by the daemon",NULL,NULL},
	{"timezone_locale", PT_char1024, &global_timezone_locale, PA_REFERENCE, "timezone specified by the clock directive",NULL,NULL},
	{"glm_save_options", PT_set, &global_glm_save_options, PA_PUBLIC, "options to control GLM file save format", gso_keys,NULL},
	{"filesave_options", PT_set, &global_filesave_options, PA_PUBLIC, "control elements saved on output", fso_keys,NULL},
	{"ignore_errors", PT_bool, &global_ignore_errors, PA_PUBLIC, "disable exit on error behavior",NULL,NULL},
	{"keep_progress", PT_bool, &global_keep_progress, PA_PUBLIC, "keep each progress line",NULL,NULL},
	{"allow_variant_aggregates", PT_bool, &global_allow_variant_aggregates, PA_PUBLIC, "permits aggregates to include time-varying criteria",NULL,NULL},
	{"progress", PT_double, &global_progress, PA_REFERENCE, "computed progress based on clock, start, and stop times",NULL,NULL},
	{"server_keepalive", PT_bool, &global_server_keepalive, PA_PUBLIC, "flag to keep server alive after simulation is complete",NULL,NULL},
	{"pythonpath",PT_char1024,&global_pythonpath,PA_PUBLIC,"folder to append to python module search path",NULL,NULL},
	{"pythonexec",PT_char1024,&global_pythonexec,PA_REFERENCE,"python executable used to build gridlabd",NULL,NULL},
	{"datadir",PT_char1024,&global_datadir,PA_PUBLIC,"folder in which share data is stored",NULL,NULL},
	{"json_complex_format",PT_set,&global_json_complex_format,PA_PUBLIC,"JSON complex number format",jcf_keys,NULL},
	{"rusage_file",PT_char1024,&global_rusage_file,PA_PUBLIC,"file in which resource usage data is collected",NULL,NULL},
	{"rusage_rate",PT_int64,&global_rusage_rate,PA_PUBLIC,"rate at which resource usage data is collected (in seconds)",NULL,NULL},
	{"rusage",PT_char1024,&global_rusage_data,PA_PUBLIC,"rusage data",NULL,NULL},
    {"echo", PT_bool, &global_echo, PA_PUBLIC, "echo subcommands",NULL,NULL},
    {"filename",PT_char1024, &global_loader_filename, PA_REFERENCE, "current filename processed by loader",NULL,NULL},
    {"linenum",PT_int32, &global_loader_linenum, PA_REFERENCE,"current line number processed by loaded",NULL,NULL},
    {"country", PT_char8, &global_country,PA_PUBLIC,"country code",NULL,NULL},
    {"region", PT_char32, &global_region,PA_PUBLIC,"region code",NULL,NULL},
    {"organization",PT_char32, &global_organization,PA_PUBLIC,"organization name",NULL,NULL},
    {"profile_output_format",PT_set,&global_profile_output_format,PA_PUBLIC,"profiler output data format",NULL,NULL},
...
DEPRECATED const char *global_object_find(char *, int, const char *)
{
	// TODO
	return NULL;
}
