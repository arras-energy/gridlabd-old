	...
	if(oclass == NULL)
	{
		...
		if(gl_publish_variable(oclass,
			...
			PT_enumeration, "load_class", PADDR(load_class),
				PT_DEFAULT, "U",
				PT_DESCRIPTION,"Flag to track load type, not currently used for anything except sorting",
			...
			PT_complex, "constant_power_A[VA]", PADDR(constant_power[0]),
				PT_DEFAULT, "0 VA",
				PT_DESCRIPTION,"constant power load on phase A, specified as VA",
			PT_complex, "constant_power_B[VA]", PADDR(constant_power[1]),
				PT_DEFAULT, "0 VA",
				PT_DESCRIPTION,"constant power load on phase B, specified as VA",
			PT_complex, "constant_power_C[VA]", PADDR(constant_power[2]),
				PT_DEFAULT, "0 VA",
				PT_DESCRIPTION,"constant power load on phase C, specified as VA",
			PT_double, "constant_power_A_real[W]", PADDR(constant_power[0].Re()),
				PT_DEFAULT, "0 W",
				PT_DESCRIPTION,"constant power load on phase A, real only, specified as W",
			PT_double, "constant_power_B_real[W]", PADDR(constant_power[1].Re()),
				PT_DEFAULT, "0 W",
				PT_DESCRIPTION,"constant power load on phase B, real only, specified as W",
			PT_double, "constant_power_C_real[W]", PADDR(constant_power[2].Re()),
				PT_DEFAULT, "0 W",
				PT_DESCRIPTION,"constant power load on phase C, real only, specified as W",
			PT_double, "constant_power_A_reac[VAr]", PADDR(constant_power[0].Im()),
				PT_DEFAULT, "0 VAr",
				PT_DESCRIPTION,"constant power load on phase A, imaginary only, specified as VAr",
			PT_double, "constant_power_B_reac[VAr]", PADDR(constant_power[1].Im()),
				PT_DEFAULT, "0 VAr",
				PT_DESCRIPTION,"constant power load on phase B, imaginary only, specified as VAr",
			PT_double, "constant_power_C_reac[VAr]", PADDR(constant_power[2].Im()),
				PT_DEFAULT, "0 VAr",
				PT_DESCRIPTION,"constant power load on phase C, imaginary only, specified as VAr",
			PT_complex, "constant_current_A[A]", PADDR(constant_current[0]),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current load on phase A, specified as Amps",
			PT_complex, "constant_current_B[A]", PADDR(constant_current[1]),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current load on phase B, specified as Amps",
			PT_complex, "constant_current_C[A]", PADDR(constant_current[2]),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current load on phase C, specified as Amps",
			PT_double, "constant_current_A_real[A]", PADDR(constant_current[0].Re()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current load on phase A, real only, specified as Amps",
			PT_double, "constant_current_B_real[A]", PADDR(constant_current[1].Re()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current load on phase B, real only, specified as Amps",
			PT_double, "constant_current_C_real[A]", PADDR(constant_current[2].Re()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current load on phase C, real only, specified as Amps",
			PT_double, "constant_current_A_reac[A]", PADDR(constant_current[0].Im()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current load on phase A, imaginary only, specified as Amps",
			PT_double, "constant_current_B_reac[A]", PADDR(constant_current[1].Im()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current load on phase B, imaginary only, specified as Amps",
			PT_double, "constant_current_C_reac[A]", PADDR(constant_current[2].Im()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current load on phase C, imaginary only, specified as Amps",
			PT_complex, "constant_impedance_A[Ohm]", PADDR(constant_impedance[0]),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance load on phase A, specified as Ohms",
			PT_complex, "constant_impedance_B[Ohm]", PADDR(constant_impedance[1]),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance load on phase B, specified as Ohms",
			PT_complex, "constant_impedance_C[Ohm]", PADDR(constant_impedance[2]),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance load on phase C, specified as Ohms",
			PT_double, "constant_impedance_A_real[Ohm]", PADDR(constant_impedance[0].Re()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance load on phase A, real only, specified as Ohms",
			PT_double, "constant_impedance_B_real[Ohm]", PADDR(constant_impedance[1].Re()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance load on phase B, real only, specified as Ohms",
			PT_double, "constant_impedance_C_real[Ohm]", PADDR(constant_impedance[2].Re()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance load on phase C, real only, specified as Ohms",
			PT_double, "constant_impedance_A_reac[Ohm]", PADDR(constant_impedance[0].Im()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance load on phase A, imaginary only, specified as Ohms",
			PT_double, "constant_impedance_B_reac[Ohm]", PADDR(constant_impedance[1].Im()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance load on phase B, imaginary only, specified as Ohms",
			PT_double, "constant_impedance_C_reac[Ohm]", PADDR(constant_impedance[2].Im()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance load on phase C, imaginary only, specified as Ohms",

			PT_complex, "constant_power_AN[VA]", PADDR(constant_power_dy[3]),
				PT_DEFAULT, "0 VA",
				PT_DESCRIPTION,"constant power wye-connected load on phase A, specified as VA",
			PT_complex, "constant_power_BN[VA]", PADDR(constant_power_dy[4]),
				PT_DEFAULT, "0 VA",
				PT_DESCRIPTION,"constant power wye-connected load on phase B, specified as VA",
			PT_complex, "constant_power_CN[VA]", PADDR(constant_power_dy[5]),
				PT_DEFAULT, "0 VA",
				PT_DESCRIPTION,"constant power wye-connected load on phase C, specified as VA",
			PT_double, "constant_power_AN_real[W]", PADDR(constant_power_dy[3].Re()),
				PT_DEFAULT, "0 W",
				PT_DESCRIPTION,"constant power wye-connected load on phase A, real only, specified as W",
			PT_double, "constant_power_BN_real[W]", PADDR(constant_power_dy[4].Re()),
				PT_DEFAULT, "0 W",
				PT_DESCRIPTION,"constant power wye-connected load on phase B, real only, specified as W",
			PT_double, "constant_power_CN_real[W]", PADDR(constant_power_dy[5].Re()),
				PT_DEFAULT, "0 W",
				PT_DESCRIPTION,"constant power wye-connected load on phase C, real only, specified as W",
			PT_double, "constant_power_AN_reac[VAr]", PADDR(constant_power_dy[3].Im()),
				PT_DEFAULT, "0 VAr",
				PT_DESCRIPTION,"constant power wye-connected load on phase A, imaginary only, specified as VAr",
			PT_double, "constant_power_BN_reac[VAr]", PADDR(constant_power_dy[4].Im()),
				PT_DEFAULT, "0 VAr",
				PT_DESCRIPTION,"constant power wye-connected load on phase B, imaginary only, specified as VAr",
			PT_double, "constant_power_CN_reac[VAr]", PADDR(constant_power_dy[5].Im()),
				PT_DEFAULT, "0 VAr",
				PT_DESCRIPTION,"constant power wye-connected load on phase C, imaginary only, specified as VAr",
			PT_complex, "constant_current_AN[A]", PADDR(constant_current_dy[3]),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current wye-connected load on phase A, specified as Amps",
			PT_complex, "constant_current_BN[A]", PADDR(constant_current_dy[4]),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current wye-connected load on phase B, specified as Amps",
			PT_complex, "constant_current_CN[A]", PADDR(constant_current_dy[5]),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current wye-connected load on phase C, specified as Amps",
			PT_double, "constant_current_AN_real[A]", PADDR(constant_current_dy[3].Re()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current wye-connected load on phase A, real only, specified as Amps",
			PT_double, "constant_current_BN_real[A]", PADDR(constant_current_dy[4].Re()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current wye-connected load on phase B, real only, specified as Amps",
			PT_double, "constant_current_CN_real[A]", PADDR(constant_current_dy[5].Re()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current wye-connected load on phase C, real only, specified as Amps",
			PT_double, "constant_current_AN_reac[A]", PADDR(constant_current_dy[3].Im()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current wye-connected load on phase A, imaginary only, specified as Amps",
			PT_double, "constant_current_BN_reac[A]", PADDR(constant_current_dy[4].Im()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current wye-connected load on phase B, imaginary only, specified as Amps",
			PT_double, "constant_current_CN_reac[A]", PADDR(constant_current_dy[5].Im()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current wye-connected load on phase C, imaginary only, specified as Amps",
			PT_complex, "constant_impedance_AN[Ohm]", PADDR(constant_impedance_dy[3]),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance wye-connected load on phase A, specified as Ohms",
			PT_complex, "constant_impedance_BN[Ohm]", PADDR(constant_impedance_dy[4]),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance wye-connected load on phase B, specified as Ohms",
			PT_complex, "constant_impedance_CN[Ohm]", PADDR(constant_impedance_dy[5]),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance wye-connected load on phase C, specified as Ohms",
			PT_double, "constant_impedance_AN_real[Ohm]", PADDR(constant_impedance_dy[3].Re()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance wye-connected load on phase A, real only, specified as Ohms",
			PT_double, "constant_impedance_BN_real[Ohm]", PADDR(constant_impedance_dy[4].Re()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance wye-connected load on phase B, real only, specified as Ohms",
			PT_double, "constant_impedance_CN_real[Ohm]", PADDR(constant_impedance_dy[5].Re()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance wye-connected load on phase C, real only, specified as Ohms",
			PT_double, "constant_impedance_AN_reac[Ohm]", PADDR(constant_impedance_dy[3].Im()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance wye-connected load on phase A, imaginary only, specified as Ohms",
			PT_double, "constant_impedance_BN_reac[Ohm]", PADDR(constant_impedance_dy[4].Im()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance wye-connected load on phase B, imaginary only, specified as Ohms",
			PT_double, "constant_impedance_CN_reac[Ohm]", PADDR(constant_impedance_dy[5].Im()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance wye-connected load on phase C, imaginary only, specified as Ohms",

			PT_complex, "constant_power_AB[VA]", PADDR(constant_power_dy[0]),
				PT_DEFAULT, "0 VA",
				PT_DESCRIPTION,"constant power delta-connected load on phase A, specified as VA",
			PT_complex, "constant_power_BC[VA]", PADDR(constant_power_dy[1]),
				PT_DEFAULT, "0 VA",
				PT_DESCRIPTION,"constant power delta-connected load on phase B, specified as VA",
			PT_complex, "constant_power_CA[VA]", PADDR(constant_power_dy[2]),
				PT_DEFAULT, "0 VA",
				PT_DESCRIPTION,"constant power delta-connected load on phase C, specified as VA",
			PT_double, "constant_power_AB_real[W]", PADDR(constant_power_dy[0].Re()),
				PT_DEFAULT, "0 W",
				PT_DESCRIPTION,"constant power delta-connected load on phase A, real only, specified as W",
			PT_double, "constant_power_BC_real[W]", PADDR(constant_power_dy[1].Re()),
				PT_DEFAULT, "0 W",
				PT_DESCRIPTION,"constant power delta-connected load on phase B, real only, specified as W",
			PT_double, "constant_power_CA_real[W]", PADDR(constant_power_dy[2].Re()),
				PT_DEFAULT, "0 W",
				PT_DESCRIPTION,"constant power delta-connected load on phase C, real only, specified as W",
			PT_double, "constant_power_AB_reac[VAr]", PADDR(constant_power_dy[0].Im()),
				PT_DEFAULT, "0 VAr",
				PT_DESCRIPTION,"constant power delta-connected load on phase A, imaginary only, specified as VAr",
			PT_double, "constant_power_BC_reac[VAr]", PADDR(constant_power_dy[1].Im()),
				PT_DEFAULT, "0 VAr",
				PT_DESCRIPTION,"constant power delta-connected load on phase B, imaginary only, specified as VAr",
			PT_double, "constant_power_CA_reac[VAr]", PADDR(constant_power_dy[2].Im()),
				PT_DEFAULT, "0 VAr",
				PT_DESCRIPTION,"constant power delta-connected load on phase C, imaginary only, specified as VAr",
			PT_complex, "constant_current_AB[A]", PADDR(constant_current_dy[0]),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current delta-connected load on phase A, specified as Amps",
			PT_complex, "constant_current_BC[A]", PADDR(constant_current_dy[1]),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current delta-connected load on phase B, specified as Amps",
			PT_complex, "constant_current_CA[A]", PADDR(constant_current_dy[2]),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current delta-connected load on phase C, specified as Amps",
			PT_double, "constant_current_AB_real[A]", PADDR(constant_current_dy[0].Re()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current delta-connected load on phase A, real only, specified as Amps",
			PT_double, "constant_current_BC_real[A]", PADDR(constant_current_dy[1].Re()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current delta-connected load on phase B, real only, specified as Amps",
			PT_double, "constant_current_CA_real[A]", PADDR(constant_current_dy[2].Re()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current delta-connected load on phase C, real only, specified as Amps",
			PT_double, "constant_current_AB_reac[A]", PADDR(constant_current_dy[0].Im()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current delta-connected load on phase A, imaginary only, specified as Amps",
			PT_double, "constant_current_BC_reac[A]", PADDR(constant_current_dy[1].Im()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current delta-connected load on phase B, imaginary only, specified as Amps",
			PT_double, "constant_current_CA_reac[A]", PADDR(constant_current_dy[2].Im()),
				PT_DEFAULT, "0 A",
				PT_DESCRIPTION,"constant current delta-connected load on phase C, imaginary only, specified as Amps",
			PT_complex, "constant_impedance_AB[Ohm]", PADDR(constant_impedance_dy[0]),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance delta-connected load on phase A, specified as Ohms",
			PT_complex, "constant_impedance_BC[Ohm]", PADDR(constant_impedance_dy[1]),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance delta-connected load on phase B, specified as Ohms",
			PT_complex, "constant_impedance_CA[Ohm]", PADDR(constant_impedance_dy[2]),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance delta-connected load on phase C, specified as Ohms",
			PT_double, "constant_impedance_AB_real[Ohm]", PADDR(constant_impedance_dy[0].Re()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance delta-connected load on phase A, real only, specified as Ohms",
			PT_double, "constant_impedance_BC_real[Ohm]", PADDR(constant_impedance_dy[1].Re()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance delta-connected load on phase B, real only, specified as Ohms",
			PT_double, "constant_impedance_CA_real[Ohm]", PADDR(constant_impedance_dy[2].Re()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance delta-connected load on phase C, real only, specified as Ohms",
			PT_double, "constant_impedance_AB_reac[Ohm]", PADDR(constant_impedance_dy[0].Im()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance delta-connected load on phase A, imaginary only, specified as Ohms",
			PT_double, "constant_impedance_BC_reac[Ohm]", PADDR(constant_impedance_dy[1].Im()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance delta-connected load on phase B, imaginary only, specified as Ohms",
			PT_double, "constant_impedance_CA_reac[Ohm]", PADDR(constant_impedance_dy[2].Im()),
				PT_DEFAULT, "0 Ohm",
				PT_DESCRIPTION,"constant impedance delta-connected load on phase C, imaginary only, specified as Ohms",

			PT_complex,	"measured_voltage_A[V]",PADDR(measured_voltage_A),
				PT_OUTPUT,
				PT_DESCRIPTION,"current measured voltage on phase A",
			PT_complex,	"measured_voltage_B[V]",PADDR(measured_voltage_B),
				PT_OUTPUT,
				PT_DESCRIPTION,"current measured voltage on phase B",
			PT_complex,	"measured_voltage_C[V]",PADDR(measured_voltage_C),
				PT_OUTPUT,
				PT_DESCRIPTION,"current measured voltage on phase C",
			PT_complex,	"measured_voltage_AB[V]",PADDR(measured_voltage_AB),
				PT_OUTPUT,
				PT_DESCRIPTION,"current measured voltage on phases AB",
			PT_complex,	"measured_voltage_BC[V]",PADDR(measured_voltage_BC),
				PT_OUTPUT,
				PT_DESCRIPTION,"current measured voltage on phases BC",
			PT_complex,	"measured_voltage_CA[V]",PADDR(measured_voltage_CA),
				PT_OUTPUT,
				PT_DESCRIPTION,"current measured voltage on phases CA",

			PT_bool, "phase_loss_protection", PADDR(three_phase_protect),
				PT_DEFAULT, "FALSE",
				PT_DESCRIPTION, "Trip all three phases of the load if a fault occurs",
			...
			PT_double, "base_power_A[VA]",PADDR(base_power[0]),
				PT_DEFAULT, "0 VA",
				PT_DESCRIPTION,"in similar format as ZIPload, this represents the nominal power on phase A before applying ZIP fractions",
			PT_double, "base_power_B[VA]",PADDR(base_power[1]),
				PT_DEFAULT, "0 VA",
				PT_DESCRIPTION,"in similar format as ZIPload, this represents the nominal power on phase B before applying ZIP fractions",
			PT_double, "base_power_C[VA]",PADDR(base_power[2]),
				PT_DEFAULT, "0 VA",
				PT_DESCRIPTION,"in similar format as ZIPload, this represents the nominal power on phase C before applying ZIP fractions",
			PT_double, "power_pf_A[pu]",PADDR(power_pf[0]),
				PT_DEFAULT, "1 pu",
				PT_DESCRIPTION,"in similar format as ZIPload, this is the power factor of the phase A constant power portion of load",
			PT_double, "current_pf_A[pu]",PADDR(current_pf[0]),
				PT_DEFAULT, "1 pu",
				PT_DESCRIPTION,"in similar format as ZIPload, this is the power factor of the phase A constant current portion of load",
			PT_double, "impedance_pf_A[pu]",PADDR(impedance_pf[0]),
				PT_DEFAULT, "1 pu",
				PT_DESCRIPTION,"in similar format as ZIPload, this is the power factor of the phase A constant impedance portion of load",
			PT_double, "power_pf_B[pu]",PADDR(power_pf[1]),
				PT_DEFAULT, "1 pu",
				PT_DESCRIPTION,"in similar format as ZIPload, this is the power factor of the phase B constant power portion of load",
			PT_double, "current_pf_B[pu]",PADDR(current_pf[1]),
				PT_DEFAULT, "1 pu",
				PT_DESCRIPTION,"in similar format as ZIPload, this is the power factor of the phase B constant current portion of load",
			PT_double, "impedance_pf_B[pu]",PADDR(impedance_pf[1]),
				PT_DEFAULT, "1 pu",
				PT_DESCRIPTION,"in similar format as ZIPload, this is the power factor of the phase B constant impedance portion of load",
			PT_double, "power_pf_C[pu]",PADDR(power_pf[2]),
				PT_DEFAULT, "1 pu",
				PT_DESCRIPTION,"in similar format as ZIPload, this is the power factor of the phase C constant power portion of load",
			PT_double, "current_pf_C[pu]",PADDR(current_pf[2]),
				PT_DEFAULT, "1 pu",
				PT_DESCRIPTION,"in similar format as ZIPload, this is the power factor of the phase C constant current portion of load",
			PT_double, "impedance_pf_C[pu]",PADDR(impedance_pf[2]),
				PT_DEFAULT, "1 pu",
				PT_DESCRIPTION,"in similar format as ZIPload, this is the power factor of the phase C constant impedance portion of load",
			PT_double, "power_fraction_A[pu]",PADDR(power_fraction[0]),
				PT_DEFAULT, "0 pu",
				PT_DESCRIPTION,"this is the constant power fraction of base power on phase A",
			PT_double, "current_fraction_A[pu]",PADDR(current_fraction[0]),
				PT_DEFAULT, "0 pu",
				PT_DESCRIPTION,"this is the constant current fraction of base power on phase A",
			PT_double, "impedance_fraction_A[pu]",PADDR(impedance_fraction[0]),
				PT_DEFAULT, "0 pu",
				PT_DESCRIPTION,"this is the constant impedance fraction of base power on phase A",
			PT_double, "power_fraction_B[pu]",PADDR(power_fraction[1]),
				PT_DEFAULT, "0 pu",
				PT_DESCRIPTION,"this is the constant power fraction of base power on phase B",
			PT_double, "current_fraction_B[pu]",PADDR(current_fraction[1]),
				PT_DEFAULT, "0 pu",
				PT_DESCRIPTION,"this is the constant current fraction of base power on phase B",
			PT_double, "impedance_fraction_B[pu]",PADDR(impedance_fraction[1]),
				PT_DEFAULT, "0 pu",
				PT_DESCRIPTION,"this is the constant impedance fraction of base power on phase B",
			PT_double, "power_fraction_C[pu]",PADDR(power_fraction[2]),
				PT_DEFAULT, "0 pu",
				PT_DESCRIPTION,"this is the constant power fraction of base power on phase C",
			PT_double, "current_fraction_C[pu]",PADDR(current_fraction[2]),
				PT_DEFAULT, "0 pu",
				PT_DESCRIPTION,"this is the constant current fraction of base power on phase C",
			PT_double, "impedance_fraction_C[pu]",PADDR(impedance_fraction[2]),
				PT_DEFAULT, "0 pu",
				PT_DESCRIPTION,"this is the constant impedance fraction of base power on phase C",
