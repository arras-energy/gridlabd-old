	...
	if (oclass==NULL)
	{
		...
		if (gl_publish_variable(oclass,
			...
			PT_double, "measured_real_energy[Wh]", PADDR(measured_real_energy),
				PT_OUTPUT,
				PT_DESCRIPTION,"metered real energy consumption, cummalitive",
			PT_double, "measured_real_energy_delta[Wh]", PADDR(measured_real_energy_delta),
				PT_OUTPUT,
				PT_DESCRIPTION,"delta in metered real energy consumption from last specified measured_energy_delta_timestep",
			PT_double, "measured_reactive_energy[VAh]",PADDR(measured_reactive_energy),
				PT_OUTPUT,
				PT_DESCRIPTION,"metered reactive energy consumption, cummalitive",
			PT_double, "measured_reactive_energy_delta[VAh]",PADDR(measured_reactive_energy_delta),
				PT_OUTPUT,
				PT_DESCRIPTION,"delta in metered reactive energy consumption from last specified measured_energy_delta_timestep",
			PT_double, "measured_energy_delta_timestep[s]",PADDR(measured_energy_delta_timestep),
				PT_OUTPUT,
				PT_DESCRIPTION,"Period of timestep for real and reactive delta energy calculation",
			PT_complex, "measured_power[VA]", PADDR(measured_power),
				PT_OUTPUT,
				PT_DESCRIPTION,"metered complex power",
			PT_complex, "measured_power_A[VA]", PADDR(indiv_measured_power[0]),
				PT_OUTPUT,
				PT_DESCRIPTION,"metered complex power on phase A",
			PT_complex, "measured_power_B[VA]", PADDR(indiv_measured_power[1]),
				PT_OUTPUT,
				PT_DESCRIPTION,"metered complex power on phase B",
			PT_complex, "measured_power_C[VA]", PADDR(indiv_measured_power[2]),
				PT_OUTPUT,
				PT_DESCRIPTION,"metered complex power on phase C",
			PT_double, "measured_demand[W]", PADDR(measured_demand),
				PT_OUTPUT,
				PT_DESCRIPTION,"greatest metered real power during simulation",
			PT_double, "measured_real_power[W]", PADDR(measured_real_power),
				PT_OUTPUT,
				PT_DESCRIPTION,"metered real power",
			PT_double, "measured_reactive_power[VAr]", PADDR(measured_reactive_power),
				PT_OUTPUT,
				PT_DESCRIPTION,"metered reactive power",
			PT_complex, "meter_power_consumption[VA]", PADDR(meter_power_consumption),
				PT_OUTPUT,
				PT_DESCRIPTION,"metered power used for operating the meter; standby and communication losses",
			...
			PT_double, "measured_real_max_voltage_in_interval_A", PADDR(measured_real_max_voltage_in_interval[0]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured real max line-to-neutral voltage on phase A over a specified interval",
			PT_double, "measured_real_max_voltage_in_interval_B", PADDR(measured_real_max_voltage_in_interval[1]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured real max line-to-neutral voltage on phase B over a specified interval",
			PT_double, "measured_real_max_voltage_in_interval_C", PADDR(measured_real_max_voltage_in_interval[2]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured real max line-to-neutral voltage on phase C over a specified interval",
			PT_double, "measured_reactive_max_voltage_in_interval_A", PADDR(measured_reactive_max_voltage_in_interval[0]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured reactive max line-to-neutral voltage on phase A over a specified interval",
			PT_double, "measured_reactive_max_voltage_in_interval_B", PADDR(measured_reactive_max_voltage_in_interval[1]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured reactive max line-to-neutral voltage on phase B over a specified interval",
			PT_double, "measured_reactive_max_voltage_in_interval_C", PADDR(measured_reactive_max_voltage_in_interval[2]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured reactive max line-to-neutral voltage on phase C over a specified interval",
			PT_double, "measured_real_max_voltage_in_interval_AB", PADDR(measured_real_max_voltageD_in_interval[0]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured real max line-to-line voltage on phase A over a specified interval",
			PT_double, "measured_real_max_voltage_in_interval_BC", PADDR(measured_real_max_voltageD_in_interval[1]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured real max line-to-line voltage on phase B over a specified interval",
			PT_double, "measured_real_max_voltage_in_interval_CA", PADDR(measured_real_max_voltageD_in_interval[2]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured real max line-to-line voltage on phase C over a specified interval",
			PT_double, "measured_reactive_max_voltage_in_interval_AB", PADDR(measured_reactive_max_voltageD_in_interval[0]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured reactive max line-to-line voltage on phase A over a specified interval",
			PT_double, "measured_reactive_max_voltage_in_interval_BC", PADDR(measured_reactive_max_voltageD_in_interval[1]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured reactive max line-to-line voltage on phase B over a specified interval",
			PT_double, "measured_reactive_max_voltage_in_interval_CA", PADDR(measured_reactive_max_voltageD_in_interval[2]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured reactive max line-to-line voltage on phase C over a specified interval",
			PT_double, "measured_real_min_voltage_in_interval_A", PADDR(measured_real_min_voltage_in_interval[0]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured real min line-to-neutral voltage on phase A over a specified interval",
			PT_double, "measured_real_min_voltage_in_interval_B", PADDR(measured_real_min_voltage_in_interval[1]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured real min line-to-neutral voltage on phase B over a specified interval",
			PT_double, "measured_real_min_voltage_in_interval_C", PADDR(measured_real_min_voltage_in_interval[2]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured real min line-to-neutral voltage on phase C over a specified interval",
			PT_double, "measured_reactive_min_voltage_in_interval_A", PADDR(measured_reactive_min_voltage_in_interval[0]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured reactive min line-to-neutral voltage on phase A over a specified interval",
			PT_double, "measured_reactive_min_voltage_in_interval_B", PADDR(measured_reactive_min_voltage_in_interval[1]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured reactive min line-to-neutral voltage on phase B over a specified interval",
			PT_double, "measured_reactive_min_voltage_in_interval_C", PADDR(measured_reactive_min_voltage_in_interval[2]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured reactive min line-to-neutral voltage on phase C over a specified interval",
			PT_double, "measured_real_min_voltage_in_interval_AB", PADDR(measured_real_min_voltageD_in_interval[0]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured real min line-to-line voltage on phase A over a specified interval",
			PT_double, "measured_real_min_voltage_in_interval_BC", PADDR(measured_real_min_voltageD_in_interval[1]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured real min line-to-line voltage on phase B over a specified interval",
			PT_double, "measured_real_min_voltage_in_interval_CA", PADDR(measured_real_min_voltageD_in_interval[2]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured real min line-to-line voltage on phase C over a specified interval",
			PT_double, "measured_reactive_min_voltage_in_interval_AB", PADDR(measured_reactive_min_voltageD_in_interval[0]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured reactive min line-to-line voltage on phase A over a specified interval",
			PT_double, "measured_reactive_min_voltage_in_interval_BC", PADDR(measured_reactive_min_voltageD_in_interval[1]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured reactive min line-to-line voltage on phase B over a specified interval",
			PT_double, "measured_reactive_min_voltage_in_interval_CA", PADDR(measured_reactive_min_voltageD_in_interval[2]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured reactive min line-to-line voltage on phase C over a specified interval",
			PT_double, "measured_avg_voltage_mag_in_interval_A", PADDR(measured_avg_voltage_mag_in_interval[0]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured avg line-to-neutral voltage magnitude on phase A over a specified interval",
			PT_double, "measured_avg_voltage_mag_in_interval_B", PADDR(measured_avg_voltage_mag_in_interval[1]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured avg line-to-neutral voltage magnitude on phase B over a specified interval",
			PT_double, "measured_avg_voltage_mag_in_interval_C", PADDR(measured_avg_voltage_mag_in_interval[2]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured avg line-to-neutral voltage magnitude on phase C over a specified interval",
			PT_double, "measured_avg_voltage_mag_in_interval_AB", PADDR(measured_avg_voltageD_mag_in_interval[0]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured avg line-to-line voltage magnitude on phase A over a specified interval",
			PT_double, "measured_avg_voltage_mag_in_interval_BC", PADDR(measured_avg_voltageD_mag_in_interval[1]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured avg line-to-line voltage magnitude on phase B over a specified interval",
			PT_double, "measured_avg_voltage_mag_in_interval_CA", PADDR(measured_avg_voltageD_mag_in_interval[2]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured avg line-to-line voltage magnitude on phase C over a specified interval",
			PT_complex, "measured_current_A[A]", PADDR(measured_current[0]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured current on phase A",
			PT_complex, "measured_current_B[A]", PADDR(measured_current[1]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured current on phase B",
			PT_complex, "measured_current_C[A]", PADDR(measured_current[2]),
				PT_OUTPUT,
				PT_DESCRIPTION,"measured current on phase C",
			PT_bool, "customer_interrupted", PADDR(meter_interrupted),
				PT_OUTPUT,
				PT_DESCRIPTION,"Reliability flag - goes active if the customer is in an 'interrupted' state",
			PT_bool, "customer_interrupted_secondary", PADDR(meter_interrupted_secondary),
				PT_OUTPUT,
				PT_DESCRIPTION,"Reliability flag - goes active if the customer is in an 'secondary interrupted' state - i.e., momentary",
			...
			PT_double, "monthly_bill[$]", PADDR(monthly_bill),
				PT_OUTPUT,
				PT_DESCRIPTION,"Accumulator for the current month's bill",
			...
			PT_double, "previous_monthly_energy[kWh]", PADDR(previous_monthly_energy),
				PT_OUTPUT,
				PT_DESCRIPTION,"Total monthly energy for the previous month",
			PT_double, "monthly_fee[$]", PADDR(monthly_fee),
				PT_OUTPUT,
				PT_DESCRIPTION,"Once a month flat fee for customer hook-up",
			PT_double, "monthly_energy[kWh]", PADDR(monthly_energy),
				PT_OUTPUT,
				PT_DESCRIPTION,"Accumulator for the current month's energy consumption",
			PT_enumeration, "bill_mode", PADDR(bill_mode),
				PT_DEFAULT, "NONE",
				PT_DESCRIPTION,"Billing structure desired",
			...
			PT_object, "power_market", PADDR(power_market),
				PT_DESCRIPTION,"Market (auction object) where the price is being received from",
			PT_int32, "bill_day", PADDR(bill_day),
				PT_DEFAULT, "15",
				PT_DESCRIPTION,"day of month bill is to be processed (currently limited to days 1-28)",
			PT_double, "price[$/kWh]", PADDR(price),
				PT_DESCRIPTION,"current price of electricity",
			PT_double, "price_base[$/kWh]", PADDR(price_base),
				PT_DESCRIPTION, "Used only in TIERED_RTP mode to describe the price before the first tier",
			PT_double, "first_tier_price[$/kWh]", PADDR(tier_price[0]),
				PT_DESCRIPTION,"price of electricity between first tier and second tier energy usage",
			PT_double, "first_tier_energy[kWh]", PADDR(tier_energy[0]),
				PT_DESCRIPTION,"switching point between base price and first tier price",
			PT_double, "second_tier_price[$/kWh]", PADDR(tier_price[1]),
				PT_DESCRIPTION,"price of electricity between second tier and third tier energy usage",
			PT_double, "second_tier_energy[kWh]", PADDR(tier_energy[1]),
				PT_DESCRIPTION,"switching point between first tier price and second tier price",
			PT_double, "third_tier_price[$/kWh]", PADDR(tier_price[2]),
				PT_DESCRIPTION,"price of electricity when energy usage exceeds third tier energy usage",
