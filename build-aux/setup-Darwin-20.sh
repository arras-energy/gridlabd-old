...
# needed for SSL module to make proper connections, as openssl does not actually provide the certificates.
    ...
    /usr/local/opt/gridlabd/gridlabd/$VERSION/bin/python3 -m ensurepip --upgrade
	/usr/local/opt/gridlabd/gridlabd/$VERSION/bin/python3 -m pip install matplotlib Pillow pandas numpy networkx pytz pysolar PyGithub scikit-learn xlrd boto3
