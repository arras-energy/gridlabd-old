...
static char logfile[1024] = {strcat(std::getenv("GLD_VAR"),("/gridlabd/gridlabd-log").c_str() )};
static char pidfile[1024] = {strcat(std::getenv("GLD_VAR"),("/gridlabd/gridlabd-pid").c_str() )};
static char workdir[1024] = {strcat(std::getenv("GLD_VAR"),("/gridlabd").c_str() )};
#endif
