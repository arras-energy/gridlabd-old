...
static char logfile[1024] = {const char*(getenv("GLD_VAR")) + const char*("/gridlabd/gridlabd-log")};
static char pidfile[1024] = {const char*(getenv("GLD_VAR")) + const char*("/gridlabd/gridlabd-pid")};
static char workdir[1024] = {const char*(getenv("GLD_VAR")) + const char*("/gridlabd")};
#endif
