...
static char logfile[1024] = strcat{std::getenv("GLD_VAR"),"/gridlabd/gridlabd-log"};
static char pidfile[1024] = strcat{std::getenv("GLD_VAR"),"/gridlabd/gridlabd-pid"};
static char workdir[1024] = strcat{std::getenv("GLD_VAR"),"/gridlabd"};
#endif
