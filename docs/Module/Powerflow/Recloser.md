...
~~~
  object recloser {
    ...
    max_number_of_tries "<decimal>";
    number_of_tries "<decimal>";
...
The amount of time in seconds to wait before the recloser attempts to close

### `max_number_of_tries`
~~~
  double max_number_of_tries;
~~~

The number of times the recloser will try to close before permanently opening

### `number_of_tries`
~~~
  double number_of_tries;
~~~

Current number of tries recloser has attempted
