...
~~~
  object regulator {
    ...
    tap_B "<integer>";
    tap_C "<integer>";
    tap_A_change_count "<decimal>";
    tap_B_change_count "<decimal>";
    tap_C_change_count "<decimal>";
    sense_node "<string>";
    regulator_resistance "<decimal> Ohm";
    status "{OPEN,CLOSED}";
    from "<string>";
    to "<string>";
    power_in "<string> VA";
...
~~~
  object regulator {
    ...
    tap_B "0";
    tap_C "0";
    tap_A_change_count "0.0";
    tap_B_change_count "0.0";
    tap_C_change_count "0.0";
    regulator_resistance "0.0";
    status "0";
    power_in "0+0i";
    power_out "0+0i";
    power_out_real "0.0";
