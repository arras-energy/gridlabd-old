...
~~~
  ...
  object solar {
    ...
    a_coeff "<decimal>";
    b_coeff "<decimal> s/m";
    dT_coeff "<decimal> m*m*degC/kW";
    T_coeff "<decimal> %/degC";
    NOCT "<decimal> degF";
    Tmodule "<decimal> degF";
    Tambient "<decimal> degC";
    wind_speed "<decimal> mph";
    ambient_temperature "<decimal> degF";
    Insolation "<decimal> W/sf";
    Rinternal "<decimal> Ohm";
    Rated_Insolation "<decimal> W/sf";
    Pmax_temp_coeff "<decimal>";
    Voc_temp_coeff "<decimal>";
    V_Max "<string> V";
    Voc_Max "<string> V";
    Voc "<string> V";
    efficiency "<decimal> unit";
    area "<decimal> sf";
    soiling "<decimal> pu";
    derating "<decimal> pu";
    Tcell "<decimal> degC";
    ...
    VA_Out "<string> VA";
    weather "<string>";
    shading_factor "<decimal> pu";
    tilt_angle "<decimal> deg";
    orientation_azimuth "<decimal> deg";
