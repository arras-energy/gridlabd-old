...
#             dstSRS = "EPSG:4326",
    ...
    output_file = f"/usr/local/opt/gridlabd/share/gridlabd/geodata/vegetation/2020/{name}.tif"
    ...
    for coordinate in coordinates:
        ...
        for lat in lats:
            for lon in lons:
                ...
                srcname = f"/usr/local/opt/gridlabd/share/gridlabd/geodata/vegetation/2020/{name}.tif"
