...
#define {PLAYERNAME}_startdate="{DATA.index.min().strftime(WRITEOPTIONS['date_format'])}"
#define {PLAYERNAME}_stopdate="{DATA.index.max().strftime(WRITEOPTIONS['date_format'])}"
#ifndef PLAYERLIST
