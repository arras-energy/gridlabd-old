...
EXPORT CLASS *init(CALLBACKS *fntable, MODULE *module, int argc, char *argv[])
{
	...
	gl_global_create("powerflow::convergence_error_handling",PT_enumeration,&convergence_error_handling,PT_DESCRIPTION,"Flag to handle convergence error",
			...
			NULL);
	extern bool nr_profile_flag;
	gl_global_create("powerflow::nr_profile_flag", PT_bool, &nr_profile_flag,PT_DESCRIPTION, "Flag to enable NR solver profiler",NULL);
	extern char1024 nr_profile_filename;
	gl_global_create("powerflow::nr_profile_filename", PT_char1024, &nr_profile_filename,PT_DESCRIPTION, "Name of NR solver profile file",NULL);
	extern bool nr_profile_headers_flag;
	gl_global_create("powerflow::nr_profile_headers_flag", PT_bool, &nr_profile_headers_flag,PT_DESCRIPTION, "Flag to include headers in NR solver profile file",NULL);
	extern bool nr_profile_headers;
	gl_global_create("powerflow::nr_profile_headers", PT_char1024, &nr_profile_headers,PT_DESCRIPTION, "Headers in NR solver profile file",NULL);
